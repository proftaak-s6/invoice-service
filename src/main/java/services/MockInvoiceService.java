...
public class MockInvoiceService {
    ...
    private static RegionalInvoice GenerateRegionalInvoiceOpelCorsa() {
        ...
        regionalInvoiceLines.add(new RegionalInvoiceLine("Tilburg", new Date(119, 03, 01, 8, 42), new BigDecimal(1.95),
                new BigDecimal(1.95)));
        ...
        regionalInvoiceLines.add(new RegionalInvoiceLine("Tilburg", new Date(119, 03, 01, 17, 51), new BigDecimal(4.95),
                new BigDecimal(0)));
        regionalInvoiceLines.add(new RegionalInvoiceLine("Tilburg", new Date(119, 03, 02, 8, 32), new BigDecimal(1.95),
                new BigDecimal(1.95)));
    ...
    private static List<VehicleInvoice> GenerateVehicleInvoices() {
        VehicleInvoice opelCorsa = new VehicleInvoice("Opel Corsa", "32-LP-VV", GenerateRegionalInvoiceOpelCorsa(),
                GenerateKilometerInvoiceOpelCorsa());
